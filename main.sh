...
svn export https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-cpufreq &&cd luci-app-cpufreq/po && ln -s zh-cn zh_Hans
svn export https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-ramfree &&cd luci-app-ramfree/po && ln -s zh-cn zh_Hans
